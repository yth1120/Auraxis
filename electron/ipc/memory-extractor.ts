...
import type { MemoryRecord } from './memory-db';
...
输出格式示例：
[{"type":"decision","title":"使用 React Router v6","content":"项目统一使用 React Router v6，采用 createBrowserRouter API","tags":["react","routing"],"importance":4}]`;
}
