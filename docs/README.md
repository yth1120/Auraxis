...
## Appendix: v1.3.0 (DeepFlow Predecessor)

DeepFlow v1.3.0 is the predecessor of Auraxis — an Electron-based desktop Agentic coding assistant.

### Tech Stack

- Desktop framework: Electron 33 (frameless window, `contextIsolation: true`)
- Frontend: React 18 + TypeScript 5.5 + Vite 5
- UI: Ant Design 5 with custom dark / light themes
- State management: Zustand 4 (14 stores)
- AI API: axios SSE streaming, DeepSeek / OpenAI and Anthropic compatible
- Build: Vite + electron-builder (NSIS / DMG / AppImage)

### Core Capabilities

- ReAct agent loop (chat / agent dual path)
- Multi-agent scheduling and sub-agents
- Plugin extensibility and persistent project memory
- React Flow graph workflow visualization
- Structured tool output cards
- ReviewArtifact quality gate, Git commit, and file deletion tools
...
Earlier versions (independent releases): [v1.2.0](https://github.com/yth1120/Auraxis-Agent/releases/tag/deepflow-1.2.0) · [v1.1.1](https://github.com/yth1120/Auraxis-Agent/releases/tag/deepflow-1.1.1) · [v1.1.0](https://github.com/yth1120/Auraxis-Agent/releases/tag/deepflow-1.1.0)
