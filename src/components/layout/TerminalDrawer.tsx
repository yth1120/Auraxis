...
export default function TerminalDrawer({
  ...
  return (
    <div
      className={clsx(
        'shrink-0 flex flex-col bg-[var(--color-glass-panel)] border-t border-[var(--color-border-dim)] overflow-hidden transition-[height,opacity,border-color] duration-300 ease-out',
